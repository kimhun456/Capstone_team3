(function() {
    ...
    function updateShortcutInfo() {
        ...
        var resetToDefault = $("<a href='#''>" + pkt.i18n.getMessage("options_reset_to_default") + "</a>");
    ...
    function initDocumentTitle() {
        ...
        if (isOpera()) {
            ...
            platform += pkt.i18n.getMessage("yandexBrowser");
        }
        else if (isChrome()) {
            platform = "Chrome";
        }
        ...
        document.title = pkt.i18n.getMessagePlaceholder("options_title", [platform]);
    }
    ...
    function init() {
        ...
        (function initLinks() {
            ...
            $('#send-us-an-email-link').on('click', function(evt) {
                var emailURL = isChrome() ? "http://help." + baseHost + "/customer/portal/emails/new?email%5Bsubject%5D=Question+about+Pocket+Extension+for+Chrome" : "http://help." + baseHost + "/customer/portal/emails/new?email%5Bsubject%5D=Question+about+Pocket+Extension+for+Safari" ;
